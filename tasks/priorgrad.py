...
print(f"torch cude:{torch.cuda.is_available()}")
...
class PriorGradTask(BaseTask):
    ...
    def build_phone_encoder(self, data_dir):
        ...
        print(f'PPPPPPPhone_list_file:{len(phone_list_file)}')
        phone_list = json.load(open(phone_list_file))
        print(f'PPPPPPPhone_list:{len(phone_list)}')
    ...
    def prepare_vocoder_hfg(self):
        ...
        import torch
        checkpoint_file = "/u01/stt/tts/small-f2s/PriorGrad-acoustic/hifi-gan/generator_universal.pth.tar"
        config_file = "/u01/stt/tts/small-f2s/PriorGrad-acoustic/hifi-gan/config.json"
