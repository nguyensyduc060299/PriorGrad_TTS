...
import sys
sys.path.append("/u01/stt/tts/small-f2s/PriorGrad-acoustic/")
...
def process_data(raw_data_dir, encoder, wav_fns, data_dir, prefix):
    ...
    tg_fn = []
    for i in range(208):
        tg_fn_fol = glob.glob(f"{raw_data_dir}/mfa_outputs/{i}/*.TextGrid")
        tg_fn += tg_fn_fol
    print(f'tg_fn: {len(tg_fn)}')
    ...
    # print(f'mel_list:{mel_list}')
    # print(f'mel2ph_encoded_list:{mel2ph_encoded_list}')
    # print("computing phoneme-level mel statistics...")
    # print(f'mel 21:{mel_list[0][22]}')
    # print(f'mel2ph_encoded_list:{mel2ph_encoded_list[0][22]}')
    # print(f'mel 22:{mel_list[22].shape}')
    # print(f'mel2ph_encoded_list:{mel2ph_encoded_list[22].shape}')
    # print(f'mel 22:{mel_list[23].shape}')
    # print(f'mel2ph_encoded_list:{mel2ph_encoded_list[23].shape}')
    # print("1111")
    # phone_to_mel_frame[mel2ph_encoded_list[0][21]].append(mel_list[0][21])
    # print("1111")
    # print(f'phone_to_mel_frame: {len(phone_to_mel_frame)}')
    # print("2222")
    # phone_to_mel_frame[mel2ph_encoded_list[0][22]].append(mel_list[0][22])
    # print("2222")
    for i in tqdm(range(len(mel_list))):
        ...
        # print(f'I now 1: {i}')
        # print(f'I now 2: {i}')
        # print(f'len_mel:{len(mel2ph_encoded)}')
        for j in range(len(mel2ph_encoded)):
            # print(f'J now 1: {j}')
            # print(f'mel2ph_encoded: {mel2ph_encoded[j]}')
            # print(f'mel: {mel[j]}')
